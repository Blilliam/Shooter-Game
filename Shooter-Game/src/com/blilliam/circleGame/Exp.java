...
public class Exp extends Entity {
    ...
    private double magnetRange = 450; // try 400–600
    ...
    public Exp(GameObject gameObj, int value, double x, double y) {
        this.gameObj = gameObj;
        this.value = (int) Math.ceil(value * valueMult);

        radius = 5 + this.value * 2;
    ...
    public void update() {
        double px = gameObj.player1.getX() + gameObj.player1.radius;
        double py = gameObj.player1.getY() + gameObj.player1.radius;
